...
pug_html = pug_html + "\u003Clink href=\"https:\u002F\u002Ffonts.googleapis.com\u002Fcss2?family=Goldman&amp;family=Noto+Sans+TC&amp;family=Roboto:wght@300&amp;family=Rubik&amp;display=swap\" rel=\"stylesheet\"\u003E\u003Cstyle type=\"text\u002Fcss\"\u003E.viewer{font-family:Roboto;font-size:64px}.viewer.active{background:#ddd}.viewer.active .inner{background:#eee}.viewer.active .inner i{background:rgba(128,200,255,0.5);outline:1px solid red}\u003C\u002Fstyle\u003E\u003C\u002Fhead\u003E\u003Cbody\u003E\u003Cbody\u003E\u003Cdiv class=\"ldcv\"\u003E\u003Cdiv class=\"base w-1024 rwd\"\u003E\u003Cdiv class=\"inner card\"\u003E\u003Cdiv class=\"card-body\"\u003E\u003Cdiv class=\"row\"\u003E\u003Cdiv class=\"col-md\"\u003E\u003Cdiv class=\"form-group\"\u003E\u003Clabel\u003EFont Family\u003C\u002Flabel\u003E\u003Cselect class=\"form-control\" ld=\"fontfamily\"\u003E";
...
pug_html = pug_html + "\u003Coption" + (pug_attr("value", n, true, true)+pug_attr("selected", (n=="Roboto"), true, true)) + "\u003E" + (pug_escape(null == (pug_interp = n) ? "" : pug_interp)) + "\u003C\u002Foption\u003E";
      }
  } else {
    var $$l = 0;
...
pug_html = pug_html + "\u003C\u002Fselect\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"col-md\"\u003E\u003Cdiv class=\"form-group\"\u003E\u003Clabel\u003EIcon\u003C\u002Flabel\u003E\u003Cselect class=\"form-control\" ld=\"iconname\"\u003E";
...
pug_html = pug_html + "\u003Coption" + (pug_attr("value", n, true, true)+pug_attr("selected", (n=="fb"), true, true)) + "\u003E" + (pug_escape(null == (pug_interp = n) ? "" : pug_interp)) + "\u003C\u002Foption\u003E";
      }
  } else {
    var $$l = 0;
...
pug_html = pug_html + "\u003C\u002Fselect\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"col-md\"\u003E\u003Cdiv class=\"form-group\"\u003E\u003Clabel\u003EFont Size\u003C\u002Flabel\u003E\u003Cselect class=\"form-control\" ld=\"fontsize\"\u003E";
...
pug_html = pug_html + "\u003Coption" + (pug_attr("value", n, true, true)+pug_attr("selected", (n==64), true, true)) + "\u003E" + (pug_escape(null == (pug_interp = n) ? "" : pug_interp)) + "\u003C\u002Foption\u003E";
      }
  } else {
    var $$l = 0;
...
pug_html = pug_html + "\u003C\u002Fselect\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"col-md\"\u003E\u003Cdiv class=\"form-group\"\u003E\u003Clabel\u003EIcon Size\u003C\u002Flabel\u003E\u003Cselect class=\"form-control\" ld=\"iconsize\"\u003E";
...
pug_html = pug_html + "\u003Coption" + (pug_attr("value", n, true, true)+pug_attr("selected", (n==1), true, true)) + "\u003E" + (pug_escape(null == (pug_interp = n) ? "" : pug_interp)) + "\u003C\u002Foption\u003E";
      }
  } else {
    var $$l = 0;
...
pug_html = pug_html + "\u003C\u002Fselect\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"col-md\"\u003E\u003Cdiv class=\"form-group\"\u003E\u003Clabel\u003ETweak Vertically\u003C\u002Flabel\u003E\u003Cselect class=\"form-control\" ld=\"verticaloffset\"\u003E";
...
pug_html = pug_html + "\u003Coption" + (pug_attr("value", n, true, true)+pug_attr("selected", (n==0), true, true)) + "\u003E" + (pug_escape(null == (pug_interp = n) ? "" : pug_interp)) + "\u003C\u002Foption\u003E";
      }
  } else {
    var $$l = 0;
...
pug_html = pug_html + "\u003C\u002Fselect\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"bg-light p-4 border-top border-bottom\"\u003E\u003Cdiv class=\"viewer\" ld=\"viewer\"\u003E\u003Cdiv class=\"d-flex inner justify-content-center align-items-center\"\u003E\u003Cdiv\u003E\u003Cspan\u003EH\u003C\u002Fspan\u003E\u003Cspan\u003Eg\u003C\u002Fspan\u003E\u003Cspan\u003Ea\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E\u003Ci class=\"i-fb\" ld=\"icon\"\u003E\u003C\u002Fi\u003E\u003Cdiv\u003E國一ば뮤\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"card-body\"\u003E\u003Cdiv class=\"row\"\u003E\u003Cdiv class=\"col-md\"\u003E\u003Cdiv class=\"btn btn-lg btn-block btn-primary\" ld=\"hint\"\u003EToggle Hint: \u003Cspan ld=\"hint-text\"\u003EOff\u003C\u002Fspan\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003Cdiv class=\"col-md\"\u003E\u003Cdiv class=\"btn btn-lg btn-block btn-outline-dark\" data-ldcv-set=\"\"\u003EClose Popup\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fdiv\u003E\u003C\u002Fbody\u003E";
