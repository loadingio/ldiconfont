...
var fs, fsExtra, stylus, uglifycss, path, svg2ttf, jsdom, progress, colors, svgo, yargs, ref$, offsetY, ascent, argv, size, mapfile, dist, srcdir, map, progressBar, optimize, svgs, bar, local, lc, glyphs, handle;
