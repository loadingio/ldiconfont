...
var fs, fsExtra, stylus, uglifycss, path, svg2ttf, jsdom, progress, colors, svgo, yargs, ref$, offsetY, ascent, argv, size, mapfile, dist, srcdir, map, progressBar, svgs, bar, local, glyphs, handle;
...
handle = function(list){
  return new Promise(function(res, rej){
    ...
    _ = function(i){
      ...
      return svgo.optimize(d.svg).then(function(ret){
        var dom, path, e, svg;
        ...
        svg = "<?xml version=\"1.0\"?>\n<svg viewBox=\"0 0 " + size + " " + size + "\" xmlns=\"http://www.w3.org/2000/svg\">\n<path transform=\"translate(0," + offsetY + ") translate(" + size / 2 + "," + size / 2 + ") scale(1,-1) translate(-" + size / 2 + ",-" + size / 2 + ")\" d=\"" + path + "\"/>\n</svg>";
...
handle(svgs).then(function(){
  var json, stylusCode, fontSvg, ttf;
  ...
  */
  ...
  glyphs = glyphs.map(function(d, i){
    var code, name, path;
  ...
  fs.writeFileSync(path.join(dist, "ldif.json"), json);
